...
public class GuiSkyrimWorkbench extends GuiScreen {
...
public GuiSkyrimWorkbench(EntityPlayer player) {
...
if (key.equals("APPAREL")) {
this.drawString(this.fontRenderer, key, 18, this.height / 2 - this.currentCategory * 7, 16777215);
//currentItemStacks = (List<ItemStack>) getElementByIndex(inventory, this.currentCategory);
currentItemStacks = (List<ItemStack>) inventory.get(key);
...
this.drawString(this.fontRenderer, displayName + " (FINE)", 98, this.height / 2 + 14 * i - this.currentItem * 7, 16777215);
GlStateManager.scale(1.0f, 1.0f, -1.0f);
//                        drawItemImage(is, width - 100, height / 2 - 40, spin);
this.drawItemImage(is, this.width - 110, this.height / 2 - 40, this.spin);
...
private void drawItemInformation(/*Recipe recipe, boolean isInventory*/ItemStack is) {
...
this.drawCenteredString(this.fontRenderer, /*recipe.getItemStack()*/is.getDisplayName() + " (FINE)", this.width - 100, (this.height + 50) / 2 + 8, -1);
...
//RecipeUtil.addGrindstoneRecipes(this.items);
}
