...
import com.horus.skyrimmc.gui.GuiSkyrimTanningRack;
...
public class BlockSkyrimTanningRack extends Block
{
...
public BlockSkyrimTanningRack(String name, final Material materialIn) {
super(materialIn);
...
if (!worldIn.isRemote) {
Minecraft.getMinecraft().displayGuiScreen((GuiScreen)new GuiSkyrimTanningRack(playerIn));
//playerIn.displayGui(new BlockTanningRack.TanningRack(worldIn, pos)); <-- vanilla 1.12.2 code
}
return true;
}
