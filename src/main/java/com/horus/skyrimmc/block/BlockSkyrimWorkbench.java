...
import com.horus.skyrimmc.gui.GuiSkyrimWorkbench;
...
public class BlockSkyrimWorkbench extends Block
{
...
public BlockSkyrimWorkbench(String name, final Material materialIn) {
super(materialIn);
...
if (!worldIn.isRemote) {
Minecraft.getMinecraft().displayGuiScreen((GuiScreen)new GuiSkyrimWorkbench(playerIn));
