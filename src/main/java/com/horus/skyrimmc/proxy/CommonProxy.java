...
public class CommonProxy {
	...
	public static void registerItems(Register<Item> event) {
		final Item[] items = {
			...
			new ItemSkyrimIngredient("ash_hopper_jelly", 1),
            new ItemSkyrimIngredient("bear_claws", 1),
            new ItemSkyrimIngredient("blisterwort", 1),
            new ItemSkyrimIngredient("blue_butterfly_wing", 1),
            new ItemSkyrimIngredient("blue_dartwing", 1),
            new ItemSkyrimIngredient("butterfly_wing", 1),
            new ItemSkyrimIngredient("canis_root", 1),
            new ItemSkyrimIngredient("chaurus_eggs", 1),
            new ItemSkyrimIngredient("emperor_parasol_moss", 1),
            new ItemSkyrimIngredient("eye_of_sabre_cat", 1),
            new ItemSkyrimIngredient("fire_salts", 1),
            new ItemSkyrimIngredient("frost_salts", 1),
            new ItemSkyrimIngredient("gleamblossom", 1),
            new ItemSkyrimIngredient("hagraven_claw", 1),
            new ItemSkyrimIngredient("hanging_moss", 1),
            new ItemSkyrimIngredient("hawk_beak", 1),
            new ItemSkyrimIngredient("jazbay_grapes", 1),
            new ItemSkyrimIngredient("juniper_berries", 1),
            new ItemSkyrimIngredient("mudcrab_chitin", 1),
            new ItemSkyrimIngredient("netch_jelly", 1),
            new ItemSkyrimIngredient("orange_dartwing", 1),
            new ItemSkyrimIngredient("saber_cat_tooth", 1),
            new ItemSkyrimIngredient("salmon_roe", 1),
            new ItemSkyrimIngredient("skeever_tail", 1),
            new ItemSkyrimIngredient("slaughterfish_scales", 1),
            new ItemSkyrimIngredient("small_antlers", 1),
            new ItemSkyrimIngredient("snowberries", 1),
            new ItemSkyrimIngredient("spawn_ash", 1),
            new ItemSkyrimIngredient("torchbug_thorax", 1),
            new ItemSkyrimIngredient("vampire_dust", 1),
            new ItemSkyrimIngredient("void_salts", 1),
