...
public class ClientProxy extends CommonProxy {
	...
	public static void registerModels(ModelRegistryEvent event) {
		...
		registerModel(ModItems.ASH_HOPPER_JELLY, 0);
        registerModel(ModItems.BEAR_CLAWS, 0);
        registerModel(ModItems.BLISTERWORT, 0);
        registerModel(ModItems.BLUE_BUTTERFLY_WING, 0);
        registerModel(ModItems.BLUE_DARTWING, 0);
        registerModel(ModItems.BUTTERFLY_WING, 0);
        registerModel(ModItems.CANIS_ROOT, 0);
        registerModel(ModItems.CHAURUS_EGGS, 0);
        registerModel(ModItems.EMPEROR_PARASOL_MOSS, 0);
        registerModel(ModItems.EYE_OF_SABRE_CAT, 0);
        registerModel(ModItems.FIRE_SALTS, 0);
        registerModel(ModItems.FROST_SALTS, 0);
        registerModel(ModItems.GLEAMBLOSSOM, 0);
        registerModel(ModItems.HAGRAVEN_CLAW, 0);
        registerModel(ModItems.HANGING_MOSS, 0);
        registerModel(ModItems.HAWK_BEAK, 0);
        registerModel(ModItems.JAZBAY_GRAPES, 0);
        registerModel(ModItems.JUNIPER_BERRIES, 0);
        registerModel(ModItems.MUDCRAB_CHITIN, 0);
        registerModel(ModItems.NETCH_JELLY, 0);
        registerModel(ModItems.ORANGE_DARTWING, 0);
        registerModel(ModItems.SABER_CAT_TOOTH, 0);
        registerModel(ModItems.SALMON_ROE, 0);
        registerModel(ModItems.SKEEVER_TAIL, 0);
        registerModel(ModItems.SLAUGHTERFISH_SCALES, 0);
        registerModel(ModItems.SMALL_ANTLERS, 0);
        registerModel(ModItems.SNOWBERRIES, 0);
        registerModel(ModItems.SPAWN_ASH, 0);
        registerModel(ModItems.TORCHBUG_THORAX, 0);
        registerModel(ModItems.VAMPIRE_DUST, 0);
        registerModel(ModItems.VOID_SALTS, 0);
